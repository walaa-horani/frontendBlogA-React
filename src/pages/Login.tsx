...
function Login() {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-linear-to-br from-sky-50 via-cyan-50 to-emerald-50 px-4'>
        ...
        <button  className='w-full mt-5 rounded-lg bg-linear-to-r from-sky-400 to-cyan-400 text-white py-2 font-semibold hover:from-sky-500 hover:to-cyan-500 transition' disabled={loading}>{loading ? "submitting":"login"}</button>
        </form>
